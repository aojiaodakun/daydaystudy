...
//    private int restartThreadTimes;
//
...
//
//    /**
//     *  add by hzj, check and restart thread
//     */
...
//            if(restartThreadTimes++>100){
//                return;
//            }
//            try {
//                state = States.NOT_CONNECTED;
//                sessionId = 0;
//                LOG.warn("clientcnxn : sendthread is not alive and will restart "+ restartThreadTimes);
//                sendThread = new SendThread(new ClientCnxnSocketNIO(clientConfig));
//                sendThread.start();
//            } catch (IOException e) {
...
//                return;
//            }
//            LOG.warn("clientcnxn : eventthread is not alive and will restart "+ restartThreadTimes);
//            eventThread = new EventThread();
//            eventThread.start();
//        }
//    }

 ...
 * nacos注册中心客户端
 */
public class NacosNamingClient implements NacosNamingService {

    private String serverAddress;

    private NamingService namingService;

    public NacosNamingClient(String serverAddress, NamingService namingService){
    ...
    @Override
    public void batchRegisterInstance(String serviceName, String groupName, List<Instance> list) throws NacosException {
        namingService.batchRegisterInstance(serviceName, groupName, list);
    }

    @Override
    public void batchDeregisterInstance(String serviceName, String groupName, List<Instance> list) throws NacosException {
        namingService.batchDeregisterInstance(serviceName, groupName, list);
    }
    ...
    public void shutDown() throws NacosException {
        ...
        NacosFactory.removeNamingService(this.serverAddress);
    }
}
